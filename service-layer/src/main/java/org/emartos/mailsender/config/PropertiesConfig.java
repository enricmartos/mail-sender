package org.emartos.mailsender.config;
...
public class PropertiesConfig {
    ...
    private static final String DEFAULT_PROPERTIES_PATH = "/opt/conf/mailsender.properties";
    ...
    public void load() {
        CONFIG.clear();
        try {
            File externalPropertiesFile = new File(System.getProperty("mailsender.configuration.path-content", DEFAULT_PROPERTIES_PATH));
